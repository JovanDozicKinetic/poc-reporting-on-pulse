...
type EventRunning struct {
	...
	EventArrivalDate   string  `json:"EventArrivalDate" db:"EventArrivalDate"`
	EventStartDate     string  `json:"EventStartDate" db:"EventStartDate"`
	EventEndDate       string  `json:"EventEndDate" db:"EventEndDate"`
	EventDepartureDate string  `json:"EventDepartureDate" db:"EventDepartureDate"`
